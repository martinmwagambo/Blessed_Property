...
$sql1 = "SELECT * FROM statement WHERE month = '2022-01'"; 
$result1 = $conn->query($sql1);
 if(!$result1) {
     echo $conn->error;
  }
  
$sql2 = "SELECT * FROM statement WHERE month = '2022-02'"; 
$result2 = $conn->query($sql2);
 if(!$result2) {
     echo $conn->error;
  }
  
$sql3 = "SELECT * FROM statement WHERE month = '2022-03'"; 
$result3 = $conn->query($sql3);
 if(!$result3) {
     echo $conn->error;
  }

$sql4 = "SELECT * FROM statement WHERE month = '2022-04'"; 
$result4 = $conn->query($sql4);
 if(!$result4) {
     echo $conn->error;
  }

$sql5 = "SELECT * FROM statement WHERE month = '2022-05'"; 
$result5 = $conn->query($sql5);
 if(!$result5) {
     echo $conn->error;
  }

$sql6 = "SELECT * FROM statement WHERE month = '2022-06'"; 
$result6 = $conn->query($sql6);
 if(!$result6) {
     echo $conn->error;
  }

$sql7 = "SELECT * FROM statement WHERE month = '2022-07'"; 
$result7 = $conn->query($sql7);
 if(!$result7) {
     echo $conn->error;
  }

$sql8 = "SELECT * FROM statement WHERE month = '2022-08'"; 
$result8 = $conn->query($sql8);
 if(!$result8) {
     echo $conn->error;
  }
  
$sql9 = "SELECT * FROM statement WHERE month = '2022-09'"; 
$result9 = $conn->query($sql9);
 if(!$result9) {
     echo $conn->error;
  }

$sql10 = "SELECT * FROM statement WHERE month = '2022-10'"; 
$result10 = $conn->query($sql10);
 if(!$result10) {
     echo $conn->error;
  }

$sql11 = "SELECT * FROM statement WHERE month = '2022-11'"; 
$result11 = $conn->query($sql11);
 if(!$result11) {
     echo $conn->error;
  }

$sql12 = "SELECT * FROM statement WHERE month = '2022-12'"; 
...
<div class="main-content">
  ...
  <button class="accordion">January</button>
      ...
      <p class="headers"> January 2022 Invoice </p>
